...
/** Parse flags like --template next, --name my-docs, --theme monolith, --entry docs, --framework astro (exported for tests). */
...
${pc.dim("Options for init:")}
  ...
  ${pc.cyan("--theme <name>")}     Skip theme prompt (e.g. ${pc.dim("darksharp")}, ${pc.dim("monolith")})
