...
const PixelBorderUIDefaults = {
  ...
  typography: {
    font: {
      ...
      h1: { size: "2.25rem", weight: 400, lineHeight: "1.14", letterSpacing: "-0.02em" },
      h2: { size: "1.5rem", weight: 400, lineHeight: "1.24", letterSpacing: "-0.01em" },
      h3: { size: "1.25rem", weight: 400, lineHeight: "1.3" },
      h4: { size: "1.125rem", weight: 400, lineHeight: "1.4" },
      body: { size: "0.975rem", weight: 400, lineHeight: "1.8" },
