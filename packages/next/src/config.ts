...
function createDocsWorkspaceAliases(root: string, workspaceRoot: string): Record<string, string> {
  const fromWorkspace = (...parts: string[]) =>
    toTurbopackAliasPath(root, join(workspaceRoot, ...parts));

  return {
    "@farming-labs/docs": fromWorkspace("packages", "docs", "dist", "index.mjs"),
    "@farming-labs/docs/server": fromWorkspace("packages", "docs", "dist", "server.mjs"),
    "@farming-labs/docs/mcp": fromWorkspace("packages", "docs", "dist", "mcp.mjs"),
    "@farming-labs/next": fromWorkspace("packages", "next", "dist", "index.mjs"),
    "@farming-labs/next/api": fromWorkspace("packages", "next", "dist", "api.mjs"),
    "@farming-labs/next/api-reference": fromWorkspace(
      "packages",
      "next",
      "dist",
      "api-reference.mjs",
    ),
    "@farming-labs/next/api-reference.css": fromWorkspace(
      "packages",
      "next",
      "styles",
      "api-reference.css",
    ),
    "@farming-labs/next/changelog": fromWorkspace("packages", "next", "dist", "changelog.mjs"),
    "@farming-labs/next/client-callbacks": fromWorkspace(
      "packages",
      "next",
      "dist",
      "client-callbacks.mjs",
    ),
    "@farming-labs/next/config": fromWorkspace("packages", "next", "dist", "config.mjs"),
    "@farming-labs/next/layout": fromWorkspace("packages", "next", "dist", "layout.mjs"),
    "@farming-labs/next/mdx-plugins/rehype-code": fromWorkspace(
      "packages",
      "next",
      "dist",
      "mdx-plugins",
    ...
    "@farming-labs/next/mdx-plugins/rehype-toc": fromWorkspace(
      "packages",
      "next",
      "dist",
      "mdx-plugins",
    ...
    "@farming-labs/next/mdx-plugins/remark-heading": fromWorkspace(
      "packages",
      "next",
      "dist",
      "mdx-plugins",
    ...
    "@farming-labs/next/mdx-plugins/remark-og": fromWorkspace(
      "packages",
      "next",
      "dist",
      "mdx-plugins",
    ...
    "@farming-labs/next/mdx-plugins/remark-markdown-alternate": fromWorkspace(
      "packages",
      "next",
      "dist",
      "mdx-plugins",
    ...
    "@farming-labs/theme": fromWorkspace("packages", "fumadocs", "dist", "index.mjs"),
    "@farming-labs/theme/ai": fromWorkspace("packages", "fumadocs", "dist", "ai-search-dialog.mjs"),
    "@farming-labs/theme/api": fromWorkspace("packages", "fumadocs", "dist", "docs-api.mjs"),
    "@farming-labs/theme/client-hooks": fromWorkspace(
      "packages",
      "fumadocs",
      "dist",
      "docs-client-hooks.mjs",
    ),
    "@farming-labs/theme/colorful": fromWorkspace(
      "packages",
      "fumadocs",
      "dist",
      "colorful",
    ...
    "@farming-labs/theme/command-grid": fromWorkspace(
      "packages",
      "fumadocs",
      "dist",
      "command-grid",
    ...
    "@farming-labs/theme/concrete": fromWorkspace(
      "packages",
      "fumadocs",
      "dist",
      "concrete",
    ...
    "@farming-labs/theme/darkbold": fromWorkspace(
      "packages",
      "fumadocs",
      "dist",
      "darkbold",
    ...
    "@farming-labs/theme/darksharp": fromWorkspace(
      "packages",
      "fumadocs",
      "dist",
      "darksharp",
    ...
    "@farming-labs/theme/default": fromWorkspace(
      "packages",
      "fumadocs",
      "dist",
      "default",
    ...
    "@farming-labs/theme/greentree": fromWorkspace(
      "packages",
      "fumadocs",
      "dist",
      "greentree",
    ...
    "@farming-labs/theme/hardline": fromWorkspace(
      "packages",
      "fumadocs",
      "dist",
      "hardline",
    ...
    "@farming-labs/theme/ledger": fromWorkspace(
      "packages",
      "fumadocs",
      "dist",
      "ledger",
    ...
    "@farming-labs/theme/mdx": fromWorkspace("packages", "fumadocs", "dist", "mdx.mjs"),
    "@farming-labs/theme/pixel-border": fromWorkspace(
      "packages",
      "fumadocs",
      "dist",
      "pixel-border",
    ...
    "@farming-labs/theme/search": fromWorkspace("packages", "fumadocs", "dist", "search.mjs"),
    "@farming-labs/theme/shiny": fromWorkspace(
      "packages",
      "fumadocs",
      "dist",
      "shiny",
    ...
    "@farming-labs/theme/tanstack": fromWorkspace("packages", "fumadocs", "dist", "tanstack.mjs"),
  };
}
