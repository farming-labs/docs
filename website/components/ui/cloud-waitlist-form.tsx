    ...
    <div ref={rootRef} className="min-w-0 space-y-2">
      ...
      <div className="relative">
        <button
          ...
          className="flex min-w-0 w-full touch-manipulation items-start justify-between gap-3 border border-black/10 bg-black/[0.015] px-3 py-2.5 text-left text-sm text-black transition-colors hover:border-black/20 dark:border-white/10 dark:bg-white/[0.015] dark:text-white dark:hover:border-white/20"
        >
