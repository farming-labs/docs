...
const releases: Release[] = [
...

  {
    ...
    date: "Feb 18–19, 2026",
    isBeta: true,
    excerpt: "Final stretch of betas — CSS specificity fixes, theme documentation, changelog page, and mobile sidebar improvements.",
    changes: [
      {
        category: "Documentation & Pages", items: [
  ...
  },
  {
    ...
    date: "Feb 15–17, 2026",
    isBeta: true,
    excerpt: "Introduced the GreenTree theme, AI sidebar-icon mode, configurable last-updated positioning, and customizer integration.",
    changes: [
      {
        category: "GreenTree Theme", items: [
  ...
  },
  {
    ...
    date: "Feb 11–14, 2026",
    isBeta: true,
    excerpt: "Added Shiny and DarkBold themes, configurable sidebar/TOC width, page actions alignment, and cross-framework layout support.",
    changes: [
      {
        category: "New Themes", items: [
      ...
      {
        category: "Layout & Configuration", items: [
      ...
      {
        category: "Cross-Framework", items: [
  ...
  },
  {
    ...
    date: "Feb 7–10, 2026",
    isBeta: true,
    excerpt: "The foundational betas — MDX docs engine, file-system routing, search, four initial themes, the /themes showcase, and the live theme customizer.",
    changes: [
      {
      ...
      {
        category: "Theme Customizer & Showcase", items: [
        ...
        <div className="relative container mx-auto max-w-full px-6 pt-6 pb-16 text-left">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-white/60 dark:text-white/50 text-sm max-w-lg mt-1">
              All notable changes to <code className="font-mono text-white/80 dark:text-white/80">@farming-labs/docs</code> are documented here.
          ...
          >
            <div className="lg:sticky top-20 h-fit shrink-0">
              <div className="lg:w-40">
                ...
                >
                  ...
                  <span className={`font-mono font-semibold ${item.isBeta ? "text-xs" : "text-sm"}`}>
                    {item.version}
                  </span>
                </a>
            ...
            <div className="flex max-w-prose flex-col gap-4 lg:mx-auto flex-1">
              <div className="flex items-start justify-between gap-4">
                <div>
                  <h3 className={`font-medium ${item.isBeta ? "text-lg lg:text-xl" : "text-2xl lg:text-3xl"}`}>
                    {item.title}
                  </h3>
            ...
            {idx < orderedReleases.length - 1 && (
              <div className={`absolute bottom-0 left-0 right-0 h-px ${item.isBeta && orderedReleases[idx + 1]?.isBeta
