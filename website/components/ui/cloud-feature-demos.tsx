...
export function CloudEditorDemo() {
  ...
  return (
    <div className="grid h-full grid-rows-[auto_minmax(0,1fr)_auto] gap-3 overflow-hidden border border-black/10 bg-white/80 p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.6)] dark:border-white/10 dark:bg-black/50 dark:shadow-none">
      <div className="flex items-center justify-between border-b border-black/10 pb-3 dark:border-white/10">
        ...
        <span className="border border-black/10 px-2 py-1 font-mono text-[10px] uppercase tracking-[0.18em] text-black/45 dark:border-white/10 dark:text-white/45">
          draft
        </span>
      </div>
...
export function CloudSearchDemo() {
  ...
  return (
    <div className="relative grid h-full grid-rows-[auto_minmax(0,1fr)_auto] gap-3 overflow-hidden border border-black/10 bg-white p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.5)] dark:border-white/10 dark:bg-black/70 dark:shadow-none">
      <div className="border border-black/10 bg-white/90 backdrop-blur dark:border-white/10 dark:bg-black/75">
        <div className="flex items-center gap-2 px-3 py-2">
          ...
          <kbd className="border border-black/10 px-1.5 py-0.5 font-mono text-[10px] uppercase tracking-[0.14em] text-black/40 dark:border-white/10 dark:text-white/35">
            cmd k
          </kbd>
          <span className="flex size-5 items-center justify-center border border-black/10 text-black/35 dark:border-white/10 dark:text-white/35">
            <X className="size-3" />
          </span>
        </div>
      </div>
          ...
          {scenario.results.map((row, index) => {
            ...
            return (
              <div
                ...
                className={cn(
                  "grid grid-cols-[32px_minmax(0,1fr)_auto_auto] items-center gap-3 border px-3 py-2 transition-all duration-700",
                  active
      ...
      <div className="border-t border-black/10 pt-3 dark:border-white/10">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex flex-wrap items-center gap-3 font-mono text-[10px] uppercase tracking-[0.16em] text-black/40 dark:text-white/35">
