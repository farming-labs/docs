...
Seven themes are available for Next.js, SvelteKit, Astro, and Nuxt:
...
<Tabs items={["Next.js", "SvelteKit", "Astro", "Nuxt"]}>
  <Tab value="Next.js">
    ...
    2. **Asks for a theme** — one of 7 built-in themes (e.g. `fumadocs`, `darksharp`, `pixel-border`, `colorful`, `greentree`, `darkbold`, `shiny`)
