...
If the CLI cannot auto-detect your framework (no `next`, `@sveltejs/kit`, or `astro` in `package.json`), it will prompt you to choose one.
...
All themes are available for Next.js, SvelteKit, and Astro:
...
<Tabs items={["Next.js", "SvelteKit", "Astro"]}>
  <Tab value="Next.js">
