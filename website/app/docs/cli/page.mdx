...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  ...
  <Tab value="pnpm">
    ```bash title="pnpm-upgrade.sh"
    pnpm dlx @farming-labs/docs upgrade
    ```
  </Tab>
  <Tab value="yarn">
    ```bash title="yarn-upgrade.sh"
    yarn dlx @farming-labs/docs upgrade
    ```
  </Tab>
  <Tab value="bun">
    ```bash title="bun-upgrade.sh"
...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash title="npm-init-template-2.sh"
    npx @farming-labs/docs init --template next --name my-docs
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash title="pnpm-init-template-2.sh"
    pnpm dlx @farming-labs/docs init --template next --name my-docs
    ```
  </Tab>
  <Tab value="yarn">
    ```bash title="yarn-init-template-2.sh"
    yarn dlx @farming-labs/docs init --template next --name my-docs
    ```
  </Tab>
  <Tab value="bun">
    ```bash title="bun-init-template-2.sh"
    bunx @farming-labs/docs init --template next --name my-docs
    ```
  </Tab>
</Tabs>
...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash title="npm-init-existing.sh"
    cd my-app
    npx @farming-labs/docs init
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash title="pnpm-init-existing.sh"
    cd my-app
    pnpm dlx @farming-labs/docs init
    ```
  </Tab>
  <Tab value="yarn">
    ```bash title="yarn-init-existing.sh"
    cd my-app
    yarn dlx @farming-labs/docs init
    ```
  </Tab>
  <Tab value="bun">
    ```bash title="bun-init-existing.sh"
    cd my-app
    bunx @farming-labs/docs init
    ```
  </Tab>
...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">
    ```bash title="npm-upgrade-2.sh"
    npx @farming-labs/docs upgrade
    ```
  </Tab>
  <Tab value="pnpm">
    ```bash title="pnpm-upgrade-2.sh"
    pnpm dlx @farming-labs/docs upgrade
    ```
  </Tab>
  <Tab value="yarn">
    ```bash title="yarn-upgrade-2.sh"
    yarn dlx @farming-labs/docs upgrade
    ```
  </Tab>
  <Tab value="bun">
    ```bash title="bun-upgrade-2.sh"
    bunx @farming-labs/docs upgrade
    ```
  </Tab>
</Tabs>
