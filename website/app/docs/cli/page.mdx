...
| `concrete`     | Hard-edge theme with square corners and bold borders        |
| `monolith`     | Brutalist poster-style theme with offset shadows            |
...
| `--theme <name>`        | Skip theme prompt: `fumadocs`, `darksharp`, `pixel-border`, `colorful`, `darkbold`, `shiny`, `greentree`, `concrete`, `monolith` (`hardline` also works as an alias) |
