...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  ...
  <Tab value="pnpm">
    ```bash
    pnpm dlx @farming-labs/docs@latest upgrade --framework astro
    # or
    pnpm dlx @farming-labs/docs@latest upgrade astro
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn dlx @farming-labs/docs@latest upgrade --framework astro
    # or
    yarn dlx @farming-labs/docs@latest upgrade astro
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bunx @farming-labs/docs@latest upgrade --framework astro
    # or
    bunx @farming-labs/docs@latest upgrade astro
    ```
  </Tab>
</Tabs>
...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  ...
  <Tab value="pnpm">
    ```bash
    pnpm dlx @farming-labs/docs@latest upgrade              # latest stable (default)
    pnpm dlx @farming-labs/docs@latest upgrade --latest     # same
    pnpm dlx @farming-labs/docs@latest upgrade --beta       # beta versions
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn dlx @farming-labs/docs@latest upgrade              # latest stable (default)
    yarn dlx @farming-labs/docs@latest upgrade --latest     # same
    yarn dlx @farming-labs/docs@latest upgrade --beta       # beta versions
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bunx @farming-labs/docs@latest upgrade              # latest stable (default)
    bunx @farming-labs/docs@latest upgrade --latest     # same
    bunx @farming-labs/docs@latest upgrade --beta       # beta versions
    ```
  </Tab>
</Tabs>
