...
A compact neutral preset for chat, agent, and product documentation. It uses a 48px header, compact Geist typography, muted shadcn surfaces, and ghost-style page actions, with visual inspiration from <HoverLink href="https://www.assistant-ui.com/docs" title="Reference docs" description="The reference documentation uses compact navigation, muted surfaces, and a clean Fumadocs layout." linkLabel="Visit reference site" external>a public chat UI docs site</HoverLink>.
