...
@farming-labs/docs ships with ten built-in theme entrypoints. Each is a preset factory function that you pass to `defineDocs()`, and `hardline` remains as a compatibility alias of `concrete`.
...
| [Concrete](/docs/themes/concrete)         | `@farming-labs/theme/concrete`     | Hard-edge theme with strong borders     |
| [Monolith](/docs/themes/monolith)         | `@farming-labs/theme/monolith`     | Brutalist poster-style hard-edge theme  |
| [Hardline](/docs/themes/hardline)         | `@farming-labs/theme/hardline`     | Compatibility alias for Concrete        |
