...
@farming-labs/docs ships with eight built-in themes. Each is a preset factory function that you pass to `defineDocs()`.
...
| [Hardline](/docs/themes/hardline)         | `@farming-labs/theme/hardline`     | Hard-edge high-contrast UI                  |
