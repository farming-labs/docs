...
can keep the built-in popover UI while changing its preview label, CTA label, or alignment across
your docs. If you want to replace the component completely, use `components.HoverLink` in
...
export const MyThemeDefaults = {
  ...
  components: {
    ...
    HoverLink: { previewLabel: "Related guide", linkLabel: "Open page" },
  },
};
