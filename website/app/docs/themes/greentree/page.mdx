...
<HoverLink
  ...
  title="Mintlify Docs"
  description="A hosted docs platform known for compact navigation, clean typography, and strong product-doc presentation."
  linkLabel="Visit Mintlify"
  external
>
  Mintlify
</HoverLink>{" "}
— a clean, modern design with an emerald green accent, Inter typography, and a compact sidebar.
