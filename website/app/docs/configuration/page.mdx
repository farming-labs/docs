...
- `GET` and `HEAD /.well-known/agent-skills/index.json` return the hashed Agent Skills index
- `GET` and `HEAD /.well-known/agent-skills/<name>/SKILL.md` return the exact indexed skill bytes
