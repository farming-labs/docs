...
- fenced code blocks, inline code, links, images, and raw HTML are stripped before counting words unless you set `includeCode: true`
- set `includeCode: true` for code-heavy guides where examples are a meaningful part of the reading work
