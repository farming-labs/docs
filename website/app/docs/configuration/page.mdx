...
- the discovery JSON advertises `agentSpecDefault`, `agentSpecFallback`, `agents.file`, `agents.route`, `skills.file`, `skills.route`, the root and section `llms.txt` routes, `robots.route`, and sitemap routes when enabled
