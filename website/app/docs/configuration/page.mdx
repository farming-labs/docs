...
`.github/workflows/docs-review.yml` when the workflow does not already exist. In monorepos, the
file is written at the repository root and the job runs from the docs app directory.
