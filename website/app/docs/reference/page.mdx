...
| `includeTitle` | `boolean` | `false` | Prepend the current page title to copied content. For `"markdown"` format, prepends `# Title\n\n`; for `"text"` format, prepends the plain title followed by a newline. Skipped if the content already begins with the title. |
