...
| `includeCode`    | `boolean` | `false` | Count fenced code blocks and inline code in the estimate |
...
- the estimate strips code blocks, inline code, links, images, HTML, and URLs before counting unless `includeCode: true`
- use `includeCode: true` for code-heavy guides where examples are a meaningful part of the reading work
