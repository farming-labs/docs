...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  ...
  <Tab value="yarn">
    ```bash
    yarn dlx @farming-labs/docs@latest init --template next --name my-docs
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bunx @farming-labs/docs@latest init --template next --name my-docs
    ```
  </Tab>
</Tabs>
...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  ...
  <Tab value="pnpm">
    ```bash
    pnpm dlx @farming-labs/docs@latest init --template next --name my-docs --theme pixel-border
    ```
  </Tab>
  <Tab value="yarn">
    ```bash
    yarn dlx @farming-labs/docs@latest init --template next --name my-docs --theme pixel-border
    ```
  </Tab>
  <Tab value="bun">
    ```bash
    bunx @farming-labs/docs@latest init --template next --name my-docs --theme pixel-border
    ```
  </Tab>
</Tabs>
