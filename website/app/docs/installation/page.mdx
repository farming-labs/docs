...
<Callout type="info" title="Node.js requirement">
  `@farming-labs/docs` requires **Node.js 20 or later**. Make sure your local environment and any CI or deployment environments meet this minimum before installing.
</Callout>
...
<Callout type="warning" title="Do not install renderer packages directly">
  Install only the Farming Labs packages for your chosen framework (listed in each tab below). Do **not** separately install `fumadocs-openapi`, `fumadocs-ui`, `fumadocs-core`, `@scalar/core`, or `@scalar/nextjs-api-reference`. The API reference renderers are bundled inside `@farming-labs/docs` and the framework adapters; adding those packages directly can cause version conflicts.
</Callout>
...
<Tabs items={["Next.js", "TanStack Start", "SvelteKit", "Astro", "Nuxt"]}>
  <Tab value="Next.js">
    ...
    Add your theme's CSS to your global stylesheet so docs styling applies. The default `fumadocs()` theme helper uses `@farming-labs/theme/default/css`; other built-in themes use their theme name, like `@farming-labs/theme/greentree/css`.
  ...
  <Tab value="SvelteKit">
    ...
    <Tabs items={["npm", "pnpm", "yarn", "bun"]}>
      <Tab value="npm">
        ```bash title="terminal"
        npm install @farming-labs/docs @farming-labs/theme @farming-labs/svelte @farming-labs/svelte-theme
        ```
      </Tab>
      <Tab value="pnpm">
        ```bash title="terminal"
        pnpm add @farming-labs/docs @farming-labs/theme @farming-labs/svelte @farming-labs/svelte-theme
        ```
      </Tab>
      <Tab value="yarn">
        ```bash title="terminal"
        yarn add @farming-labs/docs @farming-labs/theme @farming-labs/svelte @farming-labs/svelte-theme
        ```
      </Tab>
      <Tab value="bun">
        ```bash title="terminal"
        bun add @farming-labs/docs @farming-labs/theme @farming-labs/svelte @farming-labs/svelte-theme
        ```
      </Tab>
    </Tabs>
  ...
  <Tab value="Astro">
    ...
    <Tabs items={["npm", "pnpm", "yarn", "bun"]}>
      <Tab value="npm">
        ```bash title="terminal"
        npm install @farming-labs/docs @farming-labs/theme @farming-labs/astro @farming-labs/astro-theme
        ```
      </Tab>
      <Tab value="pnpm">
        ```bash title="terminal"
        pnpm add @farming-labs/docs @farming-labs/theme @farming-labs/astro @farming-labs/astro-theme
        ```
      </Tab>
      <Tab value="yarn">
        ```bash title="terminal"
        yarn add @farming-labs/docs @farming-labs/theme @farming-labs/astro @farming-labs/astro-theme
        ```
      </Tab>
      <Tab value="bun">
        ```bash title="terminal"
        bun add @farming-labs/docs @farming-labs/theme @farming-labs/astro @farming-labs/astro-theme
        ```
      </Tab>
    </Tabs>
    ...
    Import your theme's CSS in each docs page (or in a global CSS file and import that). The example below uses `@farming-labs/theme/default/css`; for other themes use e.g. `@farming-labs/theme/greentree/css`.
  ...
  <Tab value="Nuxt">
    ...
    <Tabs items={["npm", "pnpm", "yarn", "bun"]}>
      <Tab value="npm">
        ```bash title="terminal"
        npm install @farming-labs/docs @farming-labs/theme @farming-labs/nuxt @farming-labs/nuxt-theme
        ```
      </Tab>
      <Tab value="pnpm">
        ```bash title="terminal"
        pnpm add @farming-labs/docs @farming-labs/theme @farming-labs/nuxt @farming-labs/nuxt-theme
        ```
      </Tab>
      <Tab value="yarn">
        ```bash title="terminal"
        yarn add @farming-labs/docs @farming-labs/theme @farming-labs/nuxt @farming-labs/nuxt-theme
        ```
      </Tab>
      <Tab value="bun">
        ```bash title="terminal"
        bun add @farming-labs/docs @farming-labs/theme @farming-labs/nuxt @farming-labs/nuxt-theme
        ```
      </Tab>
    </Tabs>
    ...
    Add your theme's CSS via the `css` array so docs styling applies. The default `fumadocs()` theme helper uses `@farming-labs/theme/default/css`; other built-in themes use their theme name, like `@farming-labs/theme/greentree/css`.
