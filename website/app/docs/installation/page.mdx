...
<Tabs items={["Next.js", "TanStack Start", "SvelteKit", "Astro", "Nuxt"]}>
  ...
  <Tab value="Nuxt">
    ...
    Add your theme's CSS via the `css` array so docs styling applies. Use the path that matches the theme in your config (e.g. `default` below; for `greentree` use `@farming-labs/theme/greentree/css`).
