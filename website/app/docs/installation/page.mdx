...
4. Optionally scaffold i18n by selecting locales, adding custom locale codes, and choosing a default locale
5. Ask about path aliases and which global CSS file to use (defaults are offered; press **Enter** to accept)
