...
A modern documentation framework built on top of <HoverLink href="https://fumadocs.dev" title="Fumadocs" description="The MDX docs toolkit and UI foundation that powers the core reading experience behind @farming-labs/docs." linkLabel="Visit Fumadocs" external>Fumadocs</HoverLink> and other preset providers. One config file, zero boilerplate, beautiful themes out of the box.
