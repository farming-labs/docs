...
- **CLI scaffolding** — `npx @farming-labs/docs init` detects your framework, generates config, installs deps, starts dev. Use `--template` to bootstrap a new project with one command.
