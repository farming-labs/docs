---
title: "Introduction"
description: "A modern, flexible documentation framework for Next.js, SvelteKit, Astro, and Nuxt"
icon: "book"
---
...
- **Multiple frameworks** — First-class support for Next.js, SvelteKit, Astro, and Nuxt.
- **Four themes** — Default, Darksharp, Pixel Border, and Colorful. Or build your own with `createTheme()`.
