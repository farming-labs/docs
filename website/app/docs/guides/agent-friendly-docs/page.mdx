...
5. machine surfaces like `.md`, `Signature-Agent`, `llms.txt`, `sitemap.md`, `robots.txt`, MCP, and the agent discovery spec
...
- can an agent find it through `.md`, `Signature-Agent`, `llms.txt`, sitemaps, `robots.txt`, MCP, and the discovery spec?
