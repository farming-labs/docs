...
<Callout type="info" title="Sending events to Docs Cloud">
  This page covers the runtime event stream and optional custom destinations. Connected Docs Cloud
  projects send events to Cloud automatically, store them in Cloud, and show activity in the
  dashboard. For the plain-language overview of hosted analytics and the managed services around it,
  see
...
## Send Events To Another Tool

For connected Docs Cloud projects, this callback is optional and additive. Use it when you want a
copy of events outside Docs Cloud; you do not need it for Cloud storage.
