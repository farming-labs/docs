...
<HoverLink
  ...
  title="llms.txt"
  description="An open convention for exposing website content to language models in a predictable, crawlable text format."
  linkLabel="Read the llms.txt spec"
  external
>
  <code>llms.txt</code>
</HoverLink>{" "}
content through your existing docs API — no extra route files needed. Just enable it in your config.
