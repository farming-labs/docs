...
This docs site dogfoods the section feature with one live `Guides` section. The generated compact
section file is [`/docs/guides/llms.txt`](/docs/guides/llms.txt), and the full-content sibling is
