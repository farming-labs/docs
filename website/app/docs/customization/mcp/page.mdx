...
<div className="flex flex-wrap gap-3">
  <a
    href="cursor://anysphere.cursor-deeplink/mcp/install?name=farming-labs-docs&config=eyJ1cmwiOiJodHRwczovL2RvY3MuZmFybWluZy1sYWJzLmRldi9hcGkvZG9jcy9tY3AifQ=="
    className="border border-dashed border-black/[12%] px-3 py-2 text-[11px] font-mono uppercase tracking-wider text-black/60 transition-colors hover:text-black hover:border-black/22 hover:no-underline dark:border-white/[14%] dark:text-white/60 dark:hover:text-white dark:hover:border-white/28"
  >
    Add to Cursor
  </a>
  <a
    href="vscode:mcp/install?%7B%22name%22%3A%22farming-labs-docs%22%2C%22type%22%3A%22http%22%2C%22url%22%3A%22https%3A%2F%2Fdocs.farming-labs.dev%2Fapi%2Fdocs%2Fmcp%22%7D"
    className="border border-dashed border-black/[12%] px-3 py-2 text-[11px] font-mono uppercase tracking-wider text-black/60 transition-colors hover:text-black hover:border-black/22 hover:no-underline dark:border-white/[14%] dark:text-white/60 dark:hover:text-white dark:hover:border-white/28"
  >
    Add to VS Code
  </a>
