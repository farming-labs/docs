...
only when `agent.a2a` describes a real A2A interface, using protocol `0.3` over `HTTP+JSON` by
default. Do not configure it merely because the site exposes docs, Ask AI, or MCP.
