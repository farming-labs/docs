...
```ts title="suggestedquestions.ts"
ai: {
  enabled: true,
  suggestedQuestions: [
...
```tsx title="loadingcomponent.tsx"
ai: {
  enabled: true,
  aiLabel: "Sage",
