...
- Include:
  ...
  - Your environment (Node version, package manager, framework: Next.js / SvelteKit / Astro / Nuxt)
...
- **`examples/`** — Example apps (Next.js, etc.) for testing.
...
- **GitHub Discussions** — For questions and ideas: [github.com/farming-labs/docs/discussions](https://github.com/farming-labs/docs/discussions).
