...
| **Configuration** | [configuration](./configuration/SKILL.md) | docs.config.ts options: entry, theme, staticExport, sidebar, breadcrumb, github, metadata, og, and `apiReference` including remote `specUrl` support. |
