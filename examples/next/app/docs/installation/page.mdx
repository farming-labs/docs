...
<Agent>
You are an implementation agent. When editing this installation guide, preserve the package name,
environment variable names, and verification endpoint, and double-check that the sample auth
instance still matches the documented database provider setup.
</Agent>
