---
title: "Fumadocs OpenAPI mode is now the default"
description: "The Next example now ships with the faster Fumadocs OpenAPI experience, plus a tighter docs/API switcher."
