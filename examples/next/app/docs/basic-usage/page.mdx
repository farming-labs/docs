...
<Agent>
You are an implementation agent. Keep the client and server examples aligned, verify that the
import paths and Better Auth helpers remain accurate, and preserve the route-protection examples
