<script>
  import PixelSnow from "$lib/PixelSnow.svelte";
...
<svelte:head>
  <title>Farming Labs Docs — SvelteKit Example</title>
  <meta
    name="description"
    content="Centered landing page for the Farming Labs docs SvelteKit example."
  />
</svelte:head>
...
<main class="landing-shell">
  ...
  <section class="landing">
    <div class="landing-badge">
      ...
      <span class="landing-framework">SvelteKit Example</span>
    </div>
    ...
    <div class="landing-copy">
      ...
      <p>
        ...
        This example shows the same Farming Labs docs model running on SvelteKit.
      </p>
    </div>
    ...
    <div class="landing-command">
      ...
      <div class="landing-command-shell">
        ...
        <button type="button" class="landing-command-copy" on:click={copyCommand}>
          {copied ? "Copied" : "Copy"}
        </button>
      </div>
    </div>
    ...
    <div class="landing-actions">
      <a class="landing-primary" href="/docs?lang=en">Open Example Docs</a>
