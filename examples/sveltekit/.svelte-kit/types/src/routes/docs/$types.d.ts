...
type LayoutRouteId = RouteId | "/docs/[...slug]"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.LoadProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/docs/+layout.server.js').load>>>>>>;
