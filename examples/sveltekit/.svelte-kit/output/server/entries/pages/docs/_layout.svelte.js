...
function DocsLayout($$renderer, $$props) {
  ...
  :root {
    ...
    head("1uw1g9w", $$renderer2, ($$renderer3) => {
    ...
    if (config2?.ai?.mode === "floating" && config2?.ai?.enabled) {
      $$renderer2.push("<!--[-->");
