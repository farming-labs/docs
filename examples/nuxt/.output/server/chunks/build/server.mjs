import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { inject, hasInjectionContext, getCurrentInstance, defineComponent, h, computed, unref, shallowRef, provide, shallowReactive, ref, Suspense, Fragment, createApp, watch, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, reactive, effectScope, defineAsyncComponent, mergeProps, getCurrentScope, toRef, withCtx, nextTick, isReadonly, useSSRContext, isRef, isShallow, isReactive, toRaw } from 'vue';
import { e as createError$1, p as parseURL$1, k as encodePath$1, l as decodePath, m as hasProtocol, n as isScriptProtocol, h as joinURL, w as withQuery, s as sanitizeStatusCode, o as getContext, $ as $fetch, q as createHooks, r as defu, t as executeAsync } from '../nitro/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-JqIP5kXh.mjs')
  },
  {
    name: "docs-slug",
    path: "/docs/:slug(.*)*",
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-DmLdBIA0.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-UtbtM7kR.mjs'));
...
export { _export_sfc as _, asyncDataDefaults as a, useRoute as b, createError as c, useRoute$1 as d, entry_default as default, useRouter as e, fetchDefaults as f, encodeRoutePath as g, useRuntimeConfig as h, nuxtLinkDefaults as i, navigateTo as n, resolveRouteObject as r, tryUseNuxtApp as t, useNuxtApp as u };
